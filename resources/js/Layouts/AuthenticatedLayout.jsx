...
export default function AuthenticatedLayout({ header, children }) {
    ...
    useEffect(() => {
        const message =
            flash.message ?? flash.success ?? flash.error ?? flash.warning;
        ...
        <>
            ...
            <div className="min-h-screen bg-slate-100 text-slate-900">
                <div className="flex min-h-screen">
                    <aside
                        className={`${sidebarCollapsed ? "w-20" : "w-72"} fixed inset-y-0 left-0 z-30 hidden h-screen flex-col border-r border-slate-200 bg-slate-950 text-slate-50 transition-[width] duration-200 md:flex`}
                    >
                    ...
                    {sidebarOpen && (
                        <div className="fixed inset-0 z-40 md:hidden">
                            ...
                            />
                            <aside className="fixed relative z-10 h-full w-72 shadow-2xl">
                                <Sidebar
                    ...
                    <main
                        className={`${sidebarCollapsed ? "md:ml-20" : "md:ml-72"} flex-1 transition-[margin] duration-200`}
                    >
